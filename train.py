...
message = tk.Label(window, text="An Automated Student Attendance Registering System" ,bg="blue"  ,fg="white"  ,width=40  ,height=3,font=('times', 30, 'italic bold underline'))

message.place(x=150, y=20)

lbl = tk.Label(window, text="Enter Your ID :",width=20  ,height=2  ,fg="white"  ,bg="black" ,font=('times', 15, ' bold ') )
lbl.place(x=400, y=200)

txt = tk.Entry(window,width=20  ,bg="black" ,fg="white",font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="Enter Your Name :",width=20  ,fg="white"  ,bg="black"    ,height=2 ,font=('times', 15, ' bold '))
...
copyWrite.insert("insert", "Developed by Bashat Parween & Pratiksha Dubey","", "TEAM", "superscript")
